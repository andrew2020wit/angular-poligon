...
@NgModule({
  declarations: [BindingsComponent, ParentComponent, ChildComponent, AnimationsComponent, TempComponent, Child2Component, FlexboxesComponent, GridComponent, CounterTestComponent, TestAreaComponent],
